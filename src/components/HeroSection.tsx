        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute -top-40 -right-40 w-[800px] h-[800px] opacity-[0.08]">
            <svg viewBox="0 0 800 800" className="w-full h-full">
              <ellipse cx="400" cy="400" rx="350" ry="400" fill="url(#goldGradient)" transform="rotate(-25 400 400)" />
              <defs>
                <radialGradient id="goldGradient">
                  <stop offset="0%" style={{ stopColor: '#D8BC80', stopOpacity: 0.6 }} />
                  <stop offset="100%" style={{ stopColor: '#AD8F4E', stopOpacity: 0.3 }} />
                </radialGradient>
              </defs>
            </svg>
          </div>
          ...
          <div className="absolute -bottom-32 -left-32 w-[700px] h-[700px] opacity-[0.06]">
            <svg viewBox="0 0 700 700" className="w-full h-full">
              <ellipse cx="350" cy="350" rx="320" ry="360" fill="url(#darkGradient)" transform="rotate(15 350 350)" />
              <defs>
                <radialGradient id="darkGradient">
                  <stop offset="0%" style={{ stopColor: '#122231', stopOpacity: 0.5 }} />
                  <stop offset="100%" style={{ stopColor: '#D8BC80', stopOpacity: 0.2 }} />
                </radialGradient>
              </defs>
            </svg>
          </div>
          ...
          <div className="absolute top-1/4 left-0 w-full h-px opacity-[0.08]">
            <svg viewBox="0 0 1400 200" className="w-full" preserveAspectRatio="none">
              <path d="M0,100 Q350,50 700,100 T1400,100" fill="none" stroke="#D8BC80" strokeWidth="2" />
            </svg>
          </div>

          <div className="absolute bottom-1/3 left-0 w-full h-px opacity-[0.06]">
            <svg viewBox="0 0 1400 200" className="w-full" preserveAspectRatio="none">
              <path d="M0,100 Q350,150 700,100 T1400,100" fill="none" stroke="#122231" strokeWidth="2" />
            </svg>
          </div>

          {/* Subtle floating circles */}
          <div className="absolute top-20 left-1/4 w-40 h-40 rounded-full opacity-[0.05]" style={{
            background: 'radial-gradient(circle, #D8BC80 0%, transparent 70%)'
          }}></div>
          <div className="absolute bottom-40 right-1/4 w-56 h-56 rounded-full opacity-[0.04]" style={{
            background: 'radial-gradient(circle, #122231 0%, transparent 70%)'
          }}></div>
          ...
          <div className="absolute top-32 right-1/3 w-24 h-24 opacity-[0.04]">
            <svg viewBox="0 0 100 100" className="w-full h-full">
              <polygon points="50,10 90,90 10,90" fill="#D8BC80" />
            </svg>
          </div>
          
          <div className="absolute bottom-48 left-1/4 w-20 h-20 opacity-[0.05]">
            <svg viewBox="0 0 100 100" className="w-full h-full">
              <rect x="20" y="20" width="60" height="60" fill="#122231" transform="rotate(45 50 50)" />
            </svg>
          </div>

          {/* Soft gradient overlays for depth */}
          <div className="absolute top-0 left-0 w-full h-1/3 opacity-[0.03]" style={{
            background: 'linear-gradient(180deg, #D8BC80 0%, transparent 100%)'
          }}></div>
          <div className="absolute bottom-0 left-0 w-full h-1/3 opacity-[0.03]" style={{
            background: 'linear-gradient(0deg, #122231 0%, transparent 100%)'
          }}></div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center min-h-[75vh]">
            ...
            <div className="space-y-6 lg:space-y-10">
              <div className="space-y-6 lg:space-y-8">
                <div className="space-y-4">
                  <div className="inline-block">
                    <span className="text-accent-gold text-xs sm:text-sm font-semibold tracking-[0.2em] uppercase bg-accent-gold/10 px-3 sm:px-4 py-2 rounded-full">
                      Livro Exclusivo
                    </span>
                  </div>
                  <h1 className="font-trajan text-4xl lg:text-6xl font-bold leading-tight text-dark-text tracking-wide">
                    A ROTINA <span className="text-accent-gold">QUE CURA</span>
                  </h1>
                </div>
                ...
                <div className="relative space-y-3 p-6 sm:p-8 rounded-3xl" style={{
                  ...
                  boxShadow: '0 8px 32px rgba(216, 188, 128, 0.18), 0 4px 16px rgba(0, 0, 0, 0.12)',
                  border: '1px solid rgba(216, 188, 128, 0.25)'
                }}>
              ...
              <div className="space-y-4">
                ...
                <a href="https://www.amazon.com.br/rotina-que-cura-pr%C3%A1tico-vitalidade/dp/6501663040/ref=tmm_pap_swatch_0" target="_blank" rel="noopener noreferrer" className="block mt-5">
              ...
              <div className="relative max-w-xs sm:max-w-md lg:max-w-lg mx-auto">
                ...
                <div className="absolute inset-0 -z-10 transform translate-x-4 translate-y-4">
                  <div className="w-full h-full rounded-3xl" style={{
                    background: 'linear-gradient(135deg, rgba(216, 188, 128, 0.15) 0%, rgba(173, 143, 78, 0.1) 100%)',
                    boxShadow: '0 20px 60px rgba(216, 188, 128, 0.15)'
                  }}></div>
                </div>
                
                {/* Decorative frame */}
                <div className="absolute -inset-3 rounded-3xl" style={{
                  border: '1px solid rgba(216, 188, 128, 0.2)',
                  boxShadow: '0 0 40px rgba(216, 188, 128, 0.1)'
                }}></div>
