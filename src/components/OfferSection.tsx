      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 lg:mb-16">
            <div className="inline-flex items-center gap-2 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-full text-sm sm:text-base lg:text-lg font-bold mb-4 sm:mb-6 shadow-strong" style={{
            ...
            <p className="text-lg sm:text-xl lg:text-2xl mb-4 px-2 font-bold" style={{
              color: '#b80b0b'
            }}>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="space-y-6 lg:space-y-8 order-2 lg:order-1">
              <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-strong border-l-4" style={{
                borderLeftColor: '#b80b0b'
              }}>
                <p className="text-sm sm:text-base lg:text-lg leading-relaxed text-gray-700 mb-4 sm:mb-6">
                  ...
                  <span className="font-bold" style={{ color: '#b80b0b' }}> jamais se repetirá</span>.
                </p>
                
                <div className="p-4 sm:p-6 rounded-xl" style={{
                  backgroundColor: 'rgba(184, 11, 11, 0.1)',
                  border: '1px solid rgba(184, 11, 11, 0.3)'
                }}>
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-start gap-3 sm:gap-4 p-4 sm:p-6 bg-white rounded-xl shadow-soft">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm lg:text-base text-gray-700">
                      O grande benefício aqui é o acesso a um <span className="font-bold" style={{ color: '#b80b0b' }}>VALOR EXCLUSIVO e LIMITADO</span>, 
                ...
                <div className="flex items-start gap-3 sm:gap-4 p-4 sm:p-6 bg-white rounded-xl shadow-soft">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm lg:text-base text-gray-700">
                      Esta oferta <span className="font-bold" style={{ color: '#b80b0b' }}>não se repetirá</span> após o período de pré-lançamento. 
            ...
            <div className="relative order-1 lg:order-2">
              ...
              {/* Decorative elements */}
              <div className="absolute -bottom-4 -left-4 sm:-bottom-8 sm:-left-8 w-16 h-16 sm:w-24 sm:h-24 rounded-full" style={{
                backgroundColor: 'rgba(184, 11, 11, 0.1)'
              }}></div>
              <div className="absolute -top-4 -right-4 sm:-top-8 sm:-right-8 w-20 h-20 sm:w-32 sm:h-32 rounded-full" style={{
                backgroundColor: 'rgba(184, 11, 11, 0.1)'
              }}></div>
            </div>
          </div>
            ...
            <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-strong max-w-4xl mx-auto">
              ...
              <div className="flex items-start gap-2 text-xs sm:text-sm text-gray-600 bg-light-bg p-3 sm:p-4 rounded-lg">
                ...
                <p>
                  ...
                  <span className="font-bold" style={{ color: '#b80b0b' }}> Não perca essa chance!</span>
                </p>
              </div>
            </div>
          </div>
